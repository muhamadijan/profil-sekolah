        ...
        <div class="section-body">
            <div class="mb-3">
                <ol class="breadcrumb bg-primary">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola  Gambar Depan Sekolah</a></li>
                </ol>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <a href="{{route('pegawai/navbar/create')}}" class="btn btn-success mb-4"><i class="fas fa-plus-circle"></i> Tambah  Gambar Depan Sekolah</a>&nbsp;
                        </div>
                    </div>
                    @if(session('sukses'))
                          ...
                          @foreach ($navbar as $no => $navbar)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('pegawai.navbar.edit', $navbar->id) }}" class="btn btn-sm btn-primary">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <a href="/pegawai/navbar/index/delete/{{ $navbar->id }}" class="btn btn-sm btn-danger">
