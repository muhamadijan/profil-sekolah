            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Edit Eskul</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-running"></i> Edit Eskul</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.eskul.post') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_eskul" value="{{ $eskul->nama_eskul }}" placeholder="Masukkan Nama Eskul" class="form-control @error('nama_eskul') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control alamat @error('deskripsi') is-invalid @enderror" name="deskripsi" placeholder="Masukkan Deskripsi Eskul" rows="10">{!! $eskul->deskripsi !!}</textarea>
                                @error('deskripsi')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
