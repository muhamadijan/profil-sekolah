                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.ekstrakulikuler.post') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old('title', $ekstrakulikuler->title) }}" placeholder="Masukkan Judul Kegiatan" class="form-control @error('title') is-invalid @enderror">
