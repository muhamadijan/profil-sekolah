        ...
        <div class="section-body">
            <div class="mb-3">
                <ol class="breadcrumb bg-primary">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola Prestasi</a>
                    </li>
                </ol>
            </div>
            <div class="card">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="/admin/prestasi/index/delete/{{ $prestasi->id }}"
