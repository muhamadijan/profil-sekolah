            ...
            <div class="section-body">
                <div class="mb-3">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Tambah Sarana Prasarana</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Tambah Sarana Prasarana</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('profil.sarana-prasarana.post') }}" method="POST" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" value="{{ old('judul') }}" placeholder="Masukkan Sarana prasarana" class="form-control @error('judul') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                <label for="">ISI </label>
                                <textarea class="form-control alamat @error('isi') is-invalid @enderror" name="isi" placeholder="Masukkan Isi Sarana prasarana" rows="10">{!! old('isi') !!}</textarea>
                                @error('isi')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
