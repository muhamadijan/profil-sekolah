        ...
        <div class="section-body">
            <div class="mb-3">
                ...
                <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola Vidio</a></li>
                </ol>
            </div>
            <div class="card">
                            ...
                            @foreach ($vidio as $no => $vidio)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="/profil/vidio/index/delete/{{ $vidio->id }}" class="btn btn-sm btn-danger">
