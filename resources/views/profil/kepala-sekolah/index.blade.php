        ...
        <div class="section-body">
            <div class="mb-3">
                ...
                <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola Sambutan Kelpala Sekolah</a></li>
                </ol>
            </div>
            <div class="card">
                <div class="card-header">
                <h4><i class="fas fa-chalkboard-teacher"></i> Sambutan Kepala Sekolah</h4>
                </div>
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            ...
                            @foreach ($sambutan as $no => $sambutan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('profil.kepala-sekolah.edit', $sambutan->id) }}" class="btn btn-sm btn-primary">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('profil.kepala-sekolah.detail', $sambutan->id) }}" class="btn btn-sm btn-success">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="/profil/kepala-sekolah/index/delete/{{ $sambutan->id }}" class="btn btn-sm btn-danger">
