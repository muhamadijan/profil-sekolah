            ...
            <div class="section-body">
                <div class="mb-3">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Edit Sejarah</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Edit sejarah</h4>
                    </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('profil.sejarah.post') }}" method="POST" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" value="{{$sejarah->judul}}" placeholder="Masukkan Nama sekolah" class="form-control @error('judul') is-invalid @enderror">
