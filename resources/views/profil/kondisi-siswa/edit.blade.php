            ...
            <div class="section-body">
                <div class="mb-3">
                    <ol class="breadcrumb bg-primary">
                        ...
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Edit Berita</a></li>
                    </ol>
                </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.berita.post') }}" method="POST" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="gambar" value="{{$berita->gambar}}" class="form-control @error('gambar') is-invalid @enderror">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control alamat @error('isi') is-invalid @enderror" name="isi" placeholder="Masukkan Isi Berita" rows="10">{!! $berita->isi !!}</textarea>
                                @error('isi')
                                <div class="invalid-feedback" style="display: block">
                                    {{ $message }}
                                </div>
