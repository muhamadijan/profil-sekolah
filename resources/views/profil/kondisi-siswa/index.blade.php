        ...
        <div class="section-body">
            <div class="mb-3">
                ...
                <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola Berita</a></li>
                </ol>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <a href="{{route('admin/berita/create')}}" class="btn btn-primary mb-4"><i class="fas fa-plus-circle"></i> Tambah Berita</a>&nbsp;
                        </div>
                    </div>
                            ...
                            @foreach ($beritas as $no => $berita)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('admin.berita.detail', $berita->id) }}" class="btn btn-sm btn-success">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="/admin/berita/index/delete/{{ $berita->id }}" class="btn btn-sm btn-danger">
