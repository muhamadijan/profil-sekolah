            ...
            <div class="section-body">
                <div class="mb-3">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('profil.struktur.index')}}" class="text-white text-decoration-none">Kelola  Struktur Organisasi</a></li>
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Edit  Struktur Organisasi</a></li>
                    </ol>
                </div>
