            ...
            <div class="section-body">
                <div class="mb-3">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('home')}}" class="text-white text-decoration-none">home</a></li>
                        <li class="breadcrumb-item"><a href="{{route('profil.sejarah.index')}}" class="text-white text-decoration-none">Kelola Struktur Organisasi</a></li>
                        <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Tambah Struktur Organisasi</a></li>
                    </ol>
                </div>

                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Tambah Struktur Organisasi</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('profil.struktur.post') }}" method="POST" enctype="multipart/form-data"> 
                            @csrf
