        ...
        <div class="section-body">
            <div class="mb-3">
                <ol class="breadcrumb bg-primary">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="text-white text-decoration-none">Kelola weblink</a></li>
                </ol>
            </div>
            <div class="card">
                            ...
                            @foreach ($weblink as $no => $weblink)
                                <tr>
                                    ...
                                    <td class="text-center">
                                       ...
                                       <a href="/kontak/weblink/index/delete/{{ $weblink->id }}" class="btn btn-sm btn-danger">
