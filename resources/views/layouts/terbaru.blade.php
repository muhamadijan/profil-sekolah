                        ...
                        <li class="nav-item">
                         <a class="nav-link collapsed" href="/home">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li><a class="nav-link" href="{{route('profil.iden.index')}}">Identitas</a></li>
                            ...
                            Prasarana</a></li>
                            <li><a class="nav-link" href="/admin/prestasi">Prestasi</a></li>
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link has-dropdown"><i class="fas fa-building"></i>   <span> Data Siswa</span></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i><span>Data Alumi</span></a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link has-dropdown"><i class="fas fa-users"></i><span>  <span>Fitur Pelengkap </span></span></a>
                                <ul class="dropdown-menu">
